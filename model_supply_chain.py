...
data['Supply Chain Disruption'] = data['Delay Reason'].apply(lambda x: 1 if x in ['Material shortage', 'Supply chain disruption'] else 0)

# Feature selection
features = ['Project Size (sq. m)', 'Labor Count', 'Equipment Count', 'Avg Temperature (°C)', 'Rainfall (mm)', 'Milestone', 'External Factor']
X = pd.get_dummies(data[features], drop_first=True)
y = data['Supply Chain Disruption']
...
joblib.dump(best_model, '/c:/Users/NAVYA/Documents/LNT- Hackathon/project_supply_chain_model.pkl')

...
data['Delay Duration (days)'] = data['Delay Duration (days)'].fillna(0)

# Feature selection
features = ['Project Size (sq. m)', 'Labor Count', 'Equipment Count', 'Avg Temperature (°C)', 'Rainfall (mm)', 'Humidity', 'Wind Speed', 'Weather Conditions', 'Milestone', 'External Factor', 'Max Temperature (°C)', 'Min Temperature (°C)', 'Precipitation (mm)']
...
joblib.dump(best_model, '/c:/Users/NAVYA/Documents/LNT- Hackathon/project_delay_duration_model.pkl')
